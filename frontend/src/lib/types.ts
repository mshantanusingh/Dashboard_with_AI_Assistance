...
export const MCP_SERVERS: MCPServerConfig[] = [
  {
    ...
    displayName: "Library",
    emoji: "📚",
    url: process.env.LIBRARY_MCP_URL || "http://localhost:8001",
  ...
  },
  {
    ...
    emoji: "🍽️",
    url: process.env.CAFETERIA_MCP_URL || "http://localhost:8002",
  ...
  },
  {
    ...
    displayName: "Events",
    emoji: "📅",
    url: process.env.EVENTS_MCP_URL || "http://localhost:8003",
  ...
  },
  {
    ...
    emoji: "🎓",
    url: process.env.ACADEMICS_MCP_URL || "http://localhost:8004",
